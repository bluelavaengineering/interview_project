...
RSpec.describe PopulationsController, type: :controller do
  ...
  describe "GET #show" do
    it "rejects an invalid input" do
      get :show, format: :js, xhr: true, params: { population_inquiry_form: { growth_model: 'exponential', year_number: "" } }
    ...
    it "returns http success" do
      get :show, format: :js, xhr: true, params: { population_inquiry_form: { growth_model: 'exponential', year_number: "1900" } }
      expect(response).to have_http_status(:success)
    end
